...
<p align="center">
  A dedicated developer passionate about building great experiences — from web to game.<br/>
  Always learning, always growing. Feel free to explore my repos and let's connect!
</p>
...
- ⚛️ Currently focused on **React** (frontend development)
- 🔭 Also exploring **mobile** and **game development**
- 🛠️ Learning **Laravel** for backend
- 🤖 Diving into **LLMs & Machine Learning**
- 🤝 Open to collaborations and new friendships!
...
<p align="center">
  ...
  <br/><br/>
  <em>"Programs must be written for people to read, and only incidentally for machines to execute."</em> – Harold Abelson
</p>
...
<p align="center">
  <img src="https://github-trophies.vercel.app/?username=InMochi&theme=onedark&no-frame=true&no-bg=true&margin-w=8&row=1" />
</p>
